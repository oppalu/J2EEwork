...
public class Online implements ServletContextListener, ServletContextAttributeListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/phoebegl/J2EEwork/EJBClient/count.txt"));
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/phoebegl/J2EEwork/EJBClient/count.txt"));
